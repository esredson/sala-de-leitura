...
public class Servlet extends HttpServlet {
	...
	public String livroIncluir(HttpServletRequest request) {
	...
	public String livroAlterar(HttpServletRequest request) {
	...
	public String emprestimoIncluir(HttpServletRequest request) {
	...
	public String emprestimoAlterar(HttpServletRequest request) {
